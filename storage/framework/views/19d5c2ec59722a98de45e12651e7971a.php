<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('Une fois votre compte supprimé, toutes ses ressources et données seront définitivement supprimées. Avant de supprimer votre compte, veuillez télécharger les données ou informations que vous souhaitez conserver.')); ?>
...
<?php /**PATH C:\xampp\htdocs\Tacheur_stagiaires\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>